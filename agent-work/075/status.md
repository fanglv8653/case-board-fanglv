...
- baseline: completed (`origin/main@e9fb2e0`, branch `feat/v0.7.5-four-items`, pnpm frozen install passed)
- calendar: accepted
- feishu_binding: accepted (manual/reversible local binding, 5/5 targeted tests, zero remote write path)
