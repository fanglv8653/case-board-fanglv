...
- thread_id: worker-m1-compat36-r3
- role: worker
- task_id: V083-M1-COMPAT36-R3
- title: v0.8.3 migration 36 compatibility remediation R3
- reviewer: worker_gate
- owner_scope: .agent-work\threads\worker-m1-compat36-r3
